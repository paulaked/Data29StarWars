...
print(type((db.starships.find_one({"uid": "10"}, {"_id":0, "properties.pilots": 1}))["properties"]["pilots"]))
print((db.starships.find_one({"uid": "10"}, {"_id": 0, "properties.pilots": 1}))["properties"]["pilots"])

for i in (db.starships.find_one({"uid": "10"}, {"_id": 0, "properties.pilots": 1}))["properties"]["pilots"]:
    print(type(i))